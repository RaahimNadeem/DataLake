...
import aiDescTranslations from '@/translations/Services/AI/aiDesc.json';
...
const AIDesc = () => {
  ...
  const currentLang = aiDescTranslations[language as keyof typeof aiDescTranslations];

  return (
    <section className="w-full flex flex-col rounded-t-3xl md:flex-row bg-white min-h-[120vh]" dir={language === 'ar' ? 'rtl' : 'ltr'}>
      {/* Sticky Left Column */}
