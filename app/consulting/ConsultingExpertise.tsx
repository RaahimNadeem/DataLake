...
export default function ConsultingExpertise() {
  return (
    <section className="relative w-full max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-12 md:gap-20 py-16 md:py-24 lg:py-36 px-4 md:px-10 overflow-hidden rounded-3xl mt-8 md:mt-16 shadow-2xl mb-16 md:mb-24 bg-gradient-to-br from-[#eaf1f7] via-[#f7fafc] to-[#dbeafe]">
      ...
      >
        ...
        >
          ...
          <span className="text-xl md:text-3xl font-extrabold text-[#4a6d8c] text-center leading-tight drop-shadow-lg">Our Experts</span>
        </motion.div>
      </motion.div>
    </section>
  );
