...
import consultingAddedValuesTranslations from '@/translations/ConsultingPage/consultingAddedValues.json';
...
export default function ConsultingAddedValues() {
  ...
  const currentLang = consultingAddedValuesTranslations[language as keyof typeof consultingAddedValuesTranslations];
