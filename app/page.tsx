...
import { ArrowRight, ArrowUpRight, ChevronDown, BarChart2, Database, Server, Shield, Code } from "lucide-react"
            ...
            >
              ...
              >
                ...
                <span className="relative">
                  ...
                  <svg
                    className="absolute -bottom-2 left-0 w-full h-3 text-blue-100 z-0"
                    viewBox="0 0 138 13"
                    fill="none"
                    xmlns="http://www.w3.org/2000/svg"
                  >
                    <path
                      d="M2.15393 9.95553C26.5472 5.29178 101.704 -3.58522 135.842 8.14844"
                      stroke="black"
                      strokeWidth="3"
                      strokeLinecap="round"
                    />
          ...
          <div className="container mx-auto px-6 md:px-10">
            <ScrollReveal>
              <div className="text-center mb-16">
                ...
                <h2 className="text-3xl md:text-4xl font-bold">Powering data-driven decisions for</h2>
              </div>
            </ScrollReveal>
          ...
          <div className="container mx-auto px-6 md:px-10">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <ScrollReveal delay={600} className="md:col-span-2 lg:col-span-1">
                <div className="bg-black p-8 rounded-2xl text-white shadow-xl hover-scale">
          ...
          <div className="container mx-auto px-6 md:px-10">
            <ScrollReveal>
              <div className="text-center max-w-3xl mx-auto mb-16">
                ...
                <h2 className="text-3xl md:text-5xl font-bold mb-6">Trusted by innovative companies</h2>
                <p className="text-gray-600 text-lg">
            ...
            <ScrollReveal delay={400}>
              <div className="text-center mt-12">
                <Link href="/clients" className="inline-flex items-center text-sm font-medium">
