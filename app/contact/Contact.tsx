...
const Contact = () => {
  ...
  return (
    <div
      className={`flex pt-0 sm:pt-8 flex-col bg-white ${
    ...
    >
      ...
      <section className="w-full mx-auto flex flex-col items-stretch md:flex-row gap-4 sm:gap-8 md:gap-12 py-0 sm:py-8 md:py-16 lg:py-24 px-2 sm:px-6 md:px-8 lg:px-12">
        ...
        >
          <div className="relative w-full sm:w-[90%] h-fit sm:h-64 md:h-72 lg:h-[300px] flex items-start justify-start">
            ...
            <div className="absolute inset-0 hidden md:block">
              <div
                className={`h-full w-[90%] bg-[#19232e] ${
                  language === "ar" ? "rounded-l-3xl" : "rounded-r-3xl"
                } shadow-lg`}
              />
            </div>
        ...
        >
          <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-7xl font-extrabold text-[#19232e] mb-4 sm:mb-6 md:mb-8 lg:mb-10 leading-tight">
            {currentLang.contactInfo.title}
          </h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 w-full max-w-4xl">
            ...
            <div className="space-y-4 sm:space-y-6">
              ...
              >
                ...
                <div>
                  <h3 className="font-semibold text-[#19232e] text-base sm:text-lg mb-1">
                    {currentLang.contactInfo.email}
                  </h3>
                  <a
                    href={`mailto:${currentLang.companyInfo.email}`}
                    className="text-[#4a6d8c] hover:text-[#19232e] transition-colors text-sm sm:text-base"
                  >
              ...
              >
                ...
                <div>
                  <h3 className="font-semibold text-[#19232e] text-base sm:text-lg mb-1">
                    {currentLang.contactInfo.workingHours}
                  </h3>
                  <p className="text-gray-600 text-sm sm:text-base">
                    {currentLang.companyInfo.workingHours}
                  </p>
                </div>
              </motion.div>
              ...
              >
                ...
                <div>
                  <h3 className="font-semibold text-[#19232e] text-base sm:text-lg mb-1">
                    {currentLang.contactInfo.address}
                  </h3>
                  <p className="text-gray-600 text-sm sm:text-base">
                    {currentLang.companyInfo.address}
                  </p>
                </div>
              </motion.div>
            </div>
            ...
            >
              <h3 className="font-semibold text-[#19232e] text-lg sm:text-xl mb-3 sm:mb-4">
                {currentLang.location}
              </h3>
                              <div className="w-full h-64 sm:h-80 bg-gray-100 rounded-lg overflow-hidden shadow-lg flex items-center justify-center">
                  <div className="text-center">
                    <div className="w-16 h-16 mx-auto mb-4 bg-[#4a6d8c] rounded-full flex items-center justify-center">
                      <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path>
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"></path>
                      </svg>
                    </div>
                    <p className="text-gray-600 font-medium">King Fahd Road, Riyadh</p>
                    <p className="text-gray-500 text-sm">Saudi Arabia</p>
                    <a 
                      href="https://maps.google.com/?q=King+Fahd+Road,+Riyadh,+Saudi+Arabia" 
                      target="_blank" 
                      rel="noopener noreferrer"
                      className="inline-block mt-3 px-4 py-2 bg-[#4a6d8c] text-white rounded-lg hover:bg-[#19232e] transition-colors text-sm"
                    >
                      View on Google Maps
                    </a>
                  </div>
              ...
              <div>
                <h3 className="font-semibold text-[#19232e] text-lg sm:text-xl mb-3 sm:mb-4">
                  {currentLang.servicesWeOffer}
                </h3>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3">
                  {currentLang.services.map(
      ...
      <section
        ref={faqRef}
        className="w-full mx-auto py-16 sm:py-20 md:py-24 px-4 sm:px-6 md:px-8 lg:px-12 bg-gradient-to-br "
      >
