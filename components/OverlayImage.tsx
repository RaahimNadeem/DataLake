  ...
  <section className="relative w-full my-12">
    ...
    >
      ...
      >
        ...
        >
          From data lakes to AI-powered analytics, we help enterprises harness the full potential of their data. Our comprehensive suite of services includes data engineering, machine learning implementation, and custom analytics solutions designed to drive growth and innovation.
        </motion.p>
      </motion.div>
    </motion.div>
    {/* Logos Section */}
